...
function SignIn() {
  return (
    ...
    <div className="top-14 right-5 fixed mx-8">
      ...
      <span className='p-4 rounded-2xl bg-[#6B10EA] text-white px-8'>Request Demo</span>
    </div>
    ...
    <div className="absolute right-36 ">
      ...
      <div className="bg-white absolute shadow-lg rounded-2xl p-8 w-[400px] h-[500px] max-w-md">        
        <h2 className="text-xl font-bold text-gray-800 text-center mb-4">Manager Login</h2>
        <p className="text-lg text-gray-600 text-center mb-6">Hey, Enter your details to get sign in to your account</p>
        <form>
          <div className="mb-2">
        ...
        <div className="mt-2 flex gap-4 justify-center">
          <button
            className="flex items-center p-2  border border-gray-300 rounded-md shadow-sm text-xs hover:bg-gray-100">
            <img src={google} alt="Google" className="px-2" /> Login with Google
          </button>
          <button
            className="flex items-center p-2 border border-gray-300 rounded-md text-xs shadow-sm hover:bg-gray-100">
